...
import 'package:fear_patcher/screens/about.dart';
import 'package:fear_patcher/app_shell.dart';
import 'package:fear_patcher/core/game.dart';
import 'package:fear_patcher/screens/guides.dart';
import 'package:fear_patcher/screens/settings.dart';
...
import 'package:fear_patcher/screens/launch.dart';

void main() {
  if (!Game.isGameInstalled()) {
    final lpCaption = 'No installation found!'.toNativeUtf16();
    final lpText = '''
ALMA Configurator cannot find an installation of F.E.A.R Ultimate Shooter Edition on your machine. Make sure you have F.E.A.R installed. Otherwise, try launching the base game first and try again.
'''
        .toNativeUtf16();
    MessageBox(NULL, lpText, lpCaption,
